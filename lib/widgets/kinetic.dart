        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(title, style: titleStyle ?? theme.textTheme.displaySmall),
            ],
          ),
        ),
        if (trailing != null) ...[
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: KineticLabel(kicker, color: Colors.white60),
                      ),
                      if (streak != null)
                        Container(
                          padding: const EdgeInsets.symmetric(
...
class KineticNumber extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final resolved = style ?? Theme.of(context).textTheme.displayMedium;
