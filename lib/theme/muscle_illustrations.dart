...
/// Shared muscle-category choices, fills, and dominant-muscle rules.
///
/// Category artwork is rendered from the licensed anatomical atlas in
/// `widgets/exercise_muscle_map.dart`; the old mascot PNGs are no longer part
/// of the application bundle.
abstract final class SetflowMuscleIllustrations {
  /// 대표 근육 지도를 고를 수 있는 부위 목록 — 편집기와 역매핑이 같이 쓴다.
  ...
  /// 루틴의 "옷"(근육 지도·틴트)을 고르는 판정이 화면마다 갈리면 같은
