...
2026-09-13: 사진을 기기에 보관하는 **내 기구**와 제조사별 기구 동작 187개,
맨몸 오프라인 추가 100종을 넣었다. 현재 오프라인 선택 목록은 367개이며,
기존 80종만 자동 추천 검수 목록으로 유지한다. 아래 기존 서버 적재 수치와
구분한 범위·출처·백업 계약은 [내 기구](local-equipment.md)를 참고한다.
